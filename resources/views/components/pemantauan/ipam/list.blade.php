<div x-show="view === 'list'" class="space-y-4">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Pemantauan IPAM</h1>
            <p class="mt-0.5 text-sm text-gray-500">Daftar laporan bulanan kualitas air minum</p>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr x-show="filtered().length === 0">
                            <td colspan="6" class="px-4 py-10 text-center text-sm text-gray-500">
                                <span x-show="reports.length === 0">Belum ada laporan IPAM. Mulai dengan tombol Buat Laporan Baru.</span>
