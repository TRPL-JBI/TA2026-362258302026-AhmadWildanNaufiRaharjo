<template x-if="showSuccess">
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
        <x-ui.card class="w-full max-w-sm border-0 shadow-2xl" x-on:click.stop>
            <x-ui.card-content class="space-y-4 p-6 text-center">
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-900">Pemeriksaan APAR Berhasil!</h2>
                    <p class="mt-1 text-sm text-gray-500">Data pemeriksaan telah tersimpan di sistem</p>
                </div>
                <div class="space-y-2 rounded-xl bg-gray-50 p-4 text-left text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-500">Total APAR diperiksa</span>
                        <strong class="text-gray-800" x-text="totalAPAR() + ' unit'"></strong>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Total lokasi</span>
                        <strong class="text-gray-800" x-text="totalLokasi() + ' lokasi'"></strong>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Tanggal pemeriksaan</span>
                        <strong class="text-gray-800" x-text="inspectionDate()"></strong>
                    </div>
                </div>
